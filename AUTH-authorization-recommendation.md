...
| **Ref 2** | FIPS 199 Security Categorisation | NEXUS-RMF-CAT-001 | Step 2 — Categorise | System impact level: HIGH across all three objectives (C/I/A); 15 information types mapped to SP 800-60; full justification for each objective | [02-categorise/fips199-system-categorisation.md](../02-categorise/fips199-system-categorisation.md) |
| **Ref 3** | Control Baseline Summary | NEXUS-RMF-SEL-001 | Step 3 — Select | 221 controls selected from NIST SP 800-53 Rev 5 HIGH baseline; 21 tailoring decisions documented; HIPAA mapping; AWS inherited controls | [03-select/control-baseline-summary.md](../03-select/control-baseline-summary.md) |
